...
test.describe.serial('Team Manager Flow', () => {
    ...
    test('2 - Field Booking flow', async ({ page }) => {
        ...
        await page.getByRole('cell', { name: 'Slysa 1' }).click();
        await expect(page).toHaveURL('https://club-arena-test2-bhancvd6ghf9dwd7.westeurope-01.azurewebsites.net/club/slysa/field/slysa-1');
